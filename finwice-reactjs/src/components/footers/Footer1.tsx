                ...
                <div className="footer-content our-services footer-col-block">
                  ...
                  <div className="tf-collapse-content">
                    <ul>
                      ...
                      <li className="support-item-footer caption-1">
                        <Link to={`/services-details-1`}>Operational </Link>
                      </li>
                      <li className="support-item-footer caption-1">
                        <Link to={`/services-details-2`}>Improvement</Link>
                      </li>
                      <li className="support-item-footer caption-1">
                        <Link to={`/marketing-consulting`}>
                          Marketing Strategy
                        </Link>
                      </li>
                      <li className="support-item-footer caption-1">
                ...
                <div className="footer-content our-services footer-col-block">
                  ...
                  <div className="tf-collapse-content">
                    <ul>
                      ...
                      <li className="support-item-footer caption-1">
                        <Link to={`/blog-left-sidebar`}>Blog</Link>
                      </li>
                      <li className="support-item-footer caption-1">
                        <Link to={`/case-studies-1`}>Case studies</Link>
                      </li>
                      <li className="support-item-footer caption-1">
            ...
            <div className="col-12">
              <div className="footer-bottom-inner">
                ...
                <div className="right">
                  <ul>
                    <li>
                      <Link to="/about-us" className="caption-1">
                        Terms Of Services
                      </Link>
                    </li>
                    <li>
